...
const Main = () => {
  return (
    <>
      <div className="fixed h-full w-full flex justify-center items-center bg-cover bg-[url('/cpc_paralax.jpg')]">
        {/* <img
          src="/cpclogo.png"
          alt=""
          className="h-max bg-contain  w-full md:w-1/2 lg:w-1/3 opacity-40"
        /> */}
      </div>
      <div className="w-full h-full flex flex-col relative justify-center items-center">
        <ScrollSpy offsetTop={"64px"}>
          <div
            id="home"
            className="min-h-screen flex flex-col md:flex-row justify-center items-center   px-2 md:px-12 gap-4 md:gap-10 py-12 md:py-16 md:py-0"
          >
            <Home />
          </div>
