...
const Main = () => {
  return (
    <ScrollSpy offsetTop={"64px"}>
      ...
      <div className="w-full h-full   bg-cover flex justify-center items-center  bg-[url('src/assets/test2.jpg')]">
        <div className="h-full py-8 flex flex-col justify-center items-center gap-16 backdrop-blur-sm w-full ">
          <div className="w-full flex flex-col justify-center items-center gap-4 md:gap-8 py-10 md:py-16">
            ...
            <p className="text-4xl  md:text-7xl font-serif text-slate-300 text-center">
              Cyber Peace Team
            </p>
          </div>
        </div>
