      ...
      {timeLeft.seconds > 0 ? (
        <div className="flex justify-center gap-2 md:gap-8 h-[0px]">
          <div className="flex flex-col items-center justify-center w-100 px-2 py-2 h-[50px] gap-5 font-bold">
            DAYS{" "}
            <div className="border-2 p-4 w-[65px] text-center text-2xl font-bold bg-gray-800 border-gray-800 rounded-md shadow-md shadow-cyan-500 text-cyan-500">
              {days}
            </div>
          </div>
        ...
        <div className="w-full h-full flex justify-center  ">
          <div className=" flex justify-center items-center px-6 py-3 font-bold bg-gray-800 border-gray-800 rounded-md shadow-md shadow-cyan-500 text-cyan-500">
