...
const Events = () => {
  return (
    <>
      <div className=" w-full flex flex-col h-full bg-cover bg-no-repeat bg-[url('src/assets/cpc_paralax.jpg')] ">
        <div className="flex flex-col justify-center items-center backdrop-grayscale w-full h-full">
          <div className="h-full w-screen md:w-1/2 py-2 flex flex-col gap-16 ">
            <div className="w-full flex flex-col justify-center items-center gap-4">
              <p className="text-[#0EC9AC] text-2xl  ">Our Events</p>
            </div>
            <div className="  text-center flex gap-5 md:gap-10 justify-center ">
            ...
            {/* <div className="w-full text-center">
              <span>
                Our festival annually gathers spanopular groups, performers,
                DJs, musicians, and their fans from all over the world in one
                place. Enjoy your favorite music live at Event Festival!
              </span>
            </div> */}

            <div className="flex justify-center items-center">
              <button className="bg-[#0EC9AC] w-52 py-3 font-semibold rounded-sm shadow-md shadow-[#0EC9AC] ">
                REGISTER
              </button>
            </div>
      ...
      {/* <div className=" w-full h-full bg-cover bg-no-repeat bg-[url('src/assets/cpc_paralax.jpg')] ">
        <div className="flex flex-col justify-center items-center backdrop-grayscale w-full h-full py-12">
          ...
          <div className="h-full w-full md:w-1/2 py-2 flex flex-col gap-16 ">
            <div className="w-full  text-center backdrop-blur-sm font-bold  text-6xl">
              <p className="w-full text-[#0EC9AC] text-5xl md:text-7xl relative top-24">
                BOOTCAMP
              </p>
