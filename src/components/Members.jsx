  ...
  return (
    <>
      ...
      <div className="flex flex-wrap flex-row w-full justify-center items-center  gap-12">
        <div className="min-h-[100px] w-8/12 sm:w-1/4 md:w-1/5 lg:w-1/6 bg-slate-800 rounded-lg p-5 flex flex-col  ">
          <div className="w-full flex justify-center py-4">
            <img src="src/assets/security.png" alt="" width={"50px"} />
          </div>
          <p className="text-center text-2xl text-[#0EC9AC] font-serif py-4">
            Network Security
          </p>
        </div>{" "}
        <div className="min-h-[100px] w-8/12 sm:w-1/4 md:w-1/5 lg:w-1/6 bg-slate-800 rounded-lg p-5 flex flex-col  ">
